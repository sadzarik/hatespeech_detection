...
# Шляхи до файлів
input_file = 'datasets/datasets_classes_not_augmented/class0_dataset.csv'
output_file = 'datasets/datasets_classes_not_augmented/class0_dataset.csv'

# Значення лейблу
target_label = 0  # заміни на потрібний клас
